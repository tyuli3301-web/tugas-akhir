...
<body class="bg-light">
    ...
    <div class="container mt-5">
      <div class="d-flex justify-content-between aligbs-item-center mb-4">
        <h2>Dashboard Admin - Daftar Obat</h2>
        <div>
            <a href="{{ route('katalog') }}" class="btn btn-outline-secondary me-2">Lihat Katalog</a>
            <a href="{{ toute('admin.create') }}" class="btn btn-success">+ Tambah Obat Baru</a>
        </div>
      </div>
        @if(sesion('sukses'))
        ...
        <table class="table table-striped align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><strong>{{ $obat->nama-obat }}</strong></td>
                    <td>{{$obatt->bahan_aktif }}</td>
                    <td>{{ $obat->target_hama }}</td>
                    <td>
                        <div class="d-flex">
                        <a href="{{ route('adin.edit', $obat->id) }}" class="btn btn-warning btn-sm me-2">Edit</a>
